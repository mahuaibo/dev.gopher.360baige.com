...
import (
	"flag"
	"fmt"
	"dev.gopher.360baige.com/utils/db"
	"dev.gopher.360baige.com/utils/tool"
	"html/template"
	"io/ioutil"
	"log"
	"os"
...
var tplFile = flag.String("tplFile", "./controller.tpl", "the path of tpl file")
var modelFolder = flag.String("modelFolder", "../../dev.cloud.360baige.com/controllers/", "the path for folder of model files")
